TestCase("Croaker.Filter.Tests", {
  testGetTypes: function() {
    ...
    assertThat(filter.getTypes()[0].name, 'SampleType.Core');
    assertThat(filter.getTypes()[0].metrics[0].name, 'Mantain');
    assertThat(filter.getTypes()[0].metrics[2].value, 7);
  },
  ...
  testGetTypesWithMultipleTypes: function() {
    ...
    assertThat(filter.getTypes()[0].name, 'SampleType.Core');
    assertThat(filter.getTypes()[1].name, 'OtherType.Core');
    
    assertThat(filter.getTypes()[0].metrics[0].name, 'Mantain');
    assertThat(filter.getTypes()[0].metrics[2].value, 7);
    
    assertThat(filter.getTypes()[1].metrics[0].name, 'TwilightFightNight');
    assertThat(filter.getTypes()[1].metrics[2].value, 13);
